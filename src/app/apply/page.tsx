  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-12">
      <header className="mb-8">
        ...
        <h1 className="mt-1 text-3xl">No gatekeeper. No network required.</h1>
        ...
        <button type="button" onClick={loadDemo} className="nb-btn nb-btn-sm mt-3">
          Load demo application (cold-start founder)
        </button>
      </header>

      <section className="nb-card mb-8 p-5">
        <h2 className="text-base">Give us something we can check</h2>
        ...
        <ul className="mt-3 space-y-2 text-sm">
          <li>
            <span className="font-semibold">Working links beat descriptions.</span>{" "}
            <span className="text-muted">
              Product, repo, demo, a live page. Paste anything public.
            </span>
          </li>
          <li>
            <span className="font-semibold">Numbers beat adjectives.</span>{" "}
            <span className="text-muted">
          ...
          <li>
            <span className="font-semibold">Names we can verify.</span>{" "}
            <span className="text-muted">
              Customers, pilots, accelerators, employers, publications.
            </span>
          </li>
          <li>
            <span className="font-semibold">Proof of what you did.</span>{" "}
            <span className="text-muted">
      ...
      {error && (
        <p className="mt-6 rounded-[5px] border-2 border-[var(--color-error)] bg-[var(--color-surface)] px-4 py-3 text-[var(--color-error)]">
          {error}
        </p>
      )}
    </main>
